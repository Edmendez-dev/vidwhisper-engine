...
export default function MainTranscription() {
  const { submitTranscription, pollTranscriptionStatus } =
  ...
  return (
    <Card className="bg-white/3 border border-white/10 backdrop-blur-sm shadow-2xl rounded-3xl overflow-hidden w-full">
      <CardHeader className="pt-4 sm:pt-2 px-4 sm:px-6 text-center">
        <CardTitle className="text-white/80 text-xs sm:text-sm font-medium uppercase tracking-widest">
          {t("title")}{" "}
      ...
      <CardContent className="px-4 sm:px-6 pb-4 sm:pb-6 space-y-4">
        {/* Mode toggle */}
        <div className="flex items-center gap-1 bg-white/5 border border-white/10 rounded-xl p-1 w-full sm:w-fit">
          <button
            onClick={() => {
              setInputMode("url");
              setSelectedFile(null);
            ...
            className={cn(
              "flex flex-1 sm:flex-none items-center justify-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all duration-200",
              inputMode === "url"
        ...
        {inputMode === "url" ? (
          ...
          <div className="relative">
            ...
            <Input
              ...
              className="pl-10 bg-white/5 border-white/10 text-white placeholder:text-white/25 focus:border-violet-500/60 focus:ring-violet-500/20 h-12 rounded-xl transition-all text-sm"
            />
          </div>
        ) : (
          /* File upload */
          <div
            ...
            className={cn(
              "relative flex flex-col items-center justify-center gap-3 border-2 border-dashed rounded-2xl py-8 sm:py-10 px-4 sm:px-6 cursor-pointer transition-all duration-200",
              dragOver
            ...
            {selectedFile ? (
              <>
                ...
                <div className="text-center">
                  <p className="text-white/90 font-medium text-sm break-all line-clamp-2">
                    {selectedFile.name}
                  </p>
              ...
              <>
                ...
                <div className="text-center">
                  ...
                  <p className="text-white/35 text-xs mt-1">{t("textDrag2")}</p>
                </div>
        ...
        {status === "failed" && (
          <div className="flex flex-col sm:flex-row sm:items-center gap-3 bg-red-500/10 border border-red-500/20 rounded-xl px-4 py-3">
        ...
        {status === "completed" && (
          <div className="flex flex-col sm:flex-row sm:items-center gap-3 bg-emerald-500/10 border border-emerald-500/20 rounded-xl px-4 py-3">
            <div className="flex items-center gap-3 flex-1 min-w-0">
